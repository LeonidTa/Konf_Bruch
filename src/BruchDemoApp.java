public class BruchDemoApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("b24.getNumerator / getDenumerator = " + b24.getNumerator() + " / " + b24.getDenominator());
        System.out.println("b24.getNumerator / getDenumerator = " + b15.getNumerator() + " / " + b24.getDenominator());
        System.out.println("b24.getNumerator / getDenumerator = " + b23.getNumerator() + " / " + b24.getDenominator());
